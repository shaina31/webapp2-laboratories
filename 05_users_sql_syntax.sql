CREATE DATABASE webapp_2db; --create a database / use the one used in activity # 4
...
-- values of the users table are as follows:

INSERT INTO users (name, username, email, phone, website) VALUES ("Leanne Graham", "Bret", "Sincere@april.biz", "1-770-736-8031 x56442","hildegard.org"), 
...
-- values of the addresses table are as follows:

INSERT INTO addresses (street, suite, city, zipcode, lat, lng, user_id) VALUES ("Kulas Light", "Apt. 556", "Gwenborough", "92998-3874", "-37.3159", "81.1496", 1),
...
-- values of the companies table are as follows:

INSERT INTO companies (name, catchphrase, bs, user_id) VALUES ("Romaguera-Crona", "Multi-layered client-server neural-net", "harness real-time e-markets", 1),
